                    ...
                    >
                        <div className="container mx-auto w-11/12 md:w-2/3 max-w-md">
                            ...
                            <div className="space-y-6 px-6 lg:px-6 pb-4 sm:pb-6 xl:pb-6 mt-4">
                                <div className={"flex"}>
                                    <div>
                                        <span>1. <a href="https://metamask.io/" className={"underline text-blue-500 "}>Download Metamask</a> </span> <br/>
                                        <span>2. Click the "Get started" button</span>  <br/>
                                        <span>3. Select from either of the two button "No thanks" or "I Agree" </span> <br/>
                                        <span>4. Next, Select "Create a Wallet"  </span> <br/>
                                        <span>5. Enter your preferred password and Check the "I have read and agree to the Terms of use" and Click the create button  </span> <br/>
                                        <span>6. Click next, And Reveal your Secret Words. (Save or take a picture of your Secret words for log in credentials)    </span> <br/>
                                        <span>7. Click next, and select your secret words (It should be the same series as shown before) </span> <br/>
                                        <span>8. You now have a Metamask account! </span> <br/>
                                        <span>9. Now head to RTU Connect and use your metamask wallet for log in Credentials. </span> <br/>
